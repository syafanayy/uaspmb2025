  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-900 via-red-800 to-orange-900 text-white flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-red-900/30 backdrop-blur-xl border border-red-500/30 rounded-2xl p-8 text-center">
        ...
        {/* Title */}
        <h1 className="text-3xl font-bold mb-4 text-red-300">Akses Ditolak!</h1>

        {/* Message */}
        <p className="text-red-100 mb-6">Anda tidak memiliki izin untuk mengakses halaman ini.</p>
        ...
        {session?.user?.role === "admin" && (
          <div className="bg-purple-600/20 border border-purple-500/30 rounded-lg p-4 mb-6">
            <p className="text-purple-200 text-sm">📢 Anda adalah admin dan mencoba mengakses halaman user. Gunakan fitur "Login as User" jika tersedia untuk mengakses area user.</p>
          </div>
        )}
