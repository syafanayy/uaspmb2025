// app/dashboard/products/new/page.js - Create Product Form
"use client";
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Tambahkan produk baru ke database</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Akan otomatis dibuat jika kosong"
              />
              <p className="mt-1 text-xs text-gray-500">
                Kosongkan untuk membuat SKU otomatis
              </p>
            </div>
